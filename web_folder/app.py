...
def split():
    ...
    if request.method == 'POST':
        ...
        if len(check1) != len(check2):
            ...
            for root,dirs,files in os.walk("/Users/adityadixit/Desktop/College/Coding Folder/web_folder/pdfs/"):
                for file in files:
                    os.remove("/Users/adityadixit/Desktop/College/Coding Folder/web_folder/pdfs/"+file)
            ...
            if totalpages < e: #checking if the user input of pages exceeds the pdf pages
                ...
                for i in l:
                    if "-" in i:
                        ...
                        with open("/Users/adityadixit/Desktop/web_folder/pdfs/"+outputfilename, 'wb') as output_pdf:
                            pdf_writer.write(output_pdf)

                        print("Created Pdf :",outputfilename)
                        start_page = end-start+1

                        pdfoutput = open("/Users/adityadixit/Desktop//web_folder/pdfs/"+outputfilename,'wb')
            ...
            os.remove('/Users/adityadixit/Desktop/web_folder/pdfs.zip') #removing the old pdfs.zip file

            #creating the new pdfs.zip file to send to the frontend
            '''with ZipFile("/Users/adityadixit/Desktop/College/Coding Folder/web_folder/pdfs.zip", "w") as newzip:
                for root,dirs,files in os.walk("/Users/adityadixit/Desktop/College/Coding Folder/Intertnship/web_folder/pdfs/"):
                    for file in files:
                        newzip.write('/Users/adityadixit/Desktop/College/Coding Folder/web_folder/pdfs/'+file)'''
            
            shutil.make_archive('pdfs','zip','/Users/adityadixit/Desktop/College/Coding Folder/web_folder/pdfs')
